## Generated SDC file "countup_switch.sdc"
...
create_clock -name {btn} -period 1000000.000 -waveform { 0.000 500000.000 } [get_ports {btn}]
create_clock -name {reset} -period 1000000.000 -waveform { 0.000 500000.000 } [get_ports {reset}]
#
#create_clock -name {clock2} -period 50.000 -waveform { 0.000 25.000 } [get_ports {clock2}]
#create_clock -name {clock} -period 1000000.000 -waveform { 0.000 500000.000 } [get_ports {clock}]
...
set_clock_uncertainty -rise_from [get_clocks {btn}] -rise_to [get_clocks {clock}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {btn}] -fall_to [get_clocks {clock}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {btn}] -rise_to [get_clocks {clock}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {btn}] -fall_to [get_clocks {clock}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {reset}] -rise_to [get_clocks {btn}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {reset}] -fall_to [get_clocks {btn}]  0.030  
...
set_clock_uncertainty -fall_from [get_clocks {reset}] -rise_to [get_clocks {btn}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {reset}] -fall_to [get_clocks {btn}]  0.030  
...
set_clock_uncertainty -rise_from [get_clocks {clock2}] -rise_to [get_clocks {btn}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {clock2}] -fall_to [get_clocks {btn}]  0.030  
...
set_clock_uncertainty -fall_from [get_clocks {clock2}] -rise_to [get_clocks {btn}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {clock2}] -fall_to [get_clocks {btn}]  0.030  
